   ...
   return createPortal(
    <>
      ...
      <div className={css.modal_content}>
        ...
        <button className={css.modalCloseBtn} onClick={closeModal}  type="button">X</button>
        <h1 className={css.form__title}>Enter upload superhero details</h1>
        <div className={css.form__wrapper}>

          <label className={css.label}> Name 
            <input type="text" className={css.form__control}  ref={nickname} />
            </label>
          ...
          <label className={css.label}> Description
            <textarea  type="text" className={css.form__control} ref={origin_description}  />
            </label>
          
          <label className={css.label}> Superpowers
            <input type="text" className={css.form__control} ref={superpowers} />
            </label>
          
          <label className={css.label}> Catch phrase
            <input type="text" className={css.form__control} ref={catch_phrase} />
            </label>
          
          <div className={css.btnWrapper}>
          <button className={css.btn} onClick={putHero}>Edit Hero</button>
          <button className={css.btn} onClick={deleteHero}>Delete Hero</button>
          </div>
